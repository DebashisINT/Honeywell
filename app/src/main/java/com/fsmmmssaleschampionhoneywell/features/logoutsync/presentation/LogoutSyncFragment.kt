package com.fsmmmssaleschampionhoneywell.features.logoutsync.presentation
...
import com.fsmmmssaleschampionhoneywell.app.utils.Toaster
...
import com.fsmmmssaleschampionhoneywell.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.fsmmmssaleschampionhoneywell.features.billing.api.AddBillingRepoProvider
import com.fsmmmssaleschampionhoneywell.features.billing.model.AddBillingInputParamsModel
...
import com.fsmmmssaleschampionhoneywell.features.dashboard.presentation.ReasonDialog
...
import com.fsmmmssaleschampionhoneywell.features.document.model.AddEditDocumentInputParams
import com.fsmmmssaleschampionhoneywell.features.document.model.DocumentAttachmentModel
...
import com.fsmmmssaleschampionhoneywell.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.fsmmmssaleschampionhoneywell.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.fsmmmssaleschampionhoneywell.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.fsmmmssaleschampionhoneywell.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.fsmmmssaleschampionhoneywell.features.orderhistory.model.*
...
import com.fsmmmssaleschampionhoneywell.features.quotation.model.AddQuotInputModel
import com.fsmmmssaleschampionhoneywell.features.shopdetail.presentation.api.EditShopRepoProvider
import com.fsmmmssaleschampionhoneywell.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.fsmmmssaleschampionhoneywell.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.fsmmmssaleschampionhoneywell.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.fsmmmssaleschampionhoneywell.features.timesheet.model.AddTimeSheetInputModel
import com.fsmmmssaleschampionhoneywell.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.fsmmmssaleschampionhoneywell.features.viewAllOrder.model.AddOrderInputParamsModel
import com.fsmmmssaleschampionhoneywell.features.viewAllOrder.model.AddOrderInputProductList
...
import com.fsmmmssaleschampionhoneywell.MonitorService
...
import com.fsmmmssaleschampionhoneywell.features.addshop.presentation.ShopExtraContactReq
...
import com.fsmmmssaleschampionhoneywell.features.login.model.GetConcurrentUserResponse
import com.fsmmmssaleschampionhoneywell.features.performance.model.Gps_status_list
import com.fsmmmssaleschampionhoneywell.features.performance.model.UpdateGpsInputListParamsModel
import com.fsmmmssaleschampionhoneywell.features.returnsOrder.ReturnProductList
import com.fsmmmssaleschampionhoneywell.features.returnsOrder.ReturnRequest
import com.fsmmmssaleschampionhoneywell.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfsmmmssaleschampionhoneywelllogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfsmmmssaleschampionhoneywelllogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfsmmmssaleschampionhoneywelllogsample/log.zip").path);
